package com.chaoscoffee.generator;
...
public class CodeGenerator {
    ...
    private static final String PROJECT_NAME_PATH = "\\springcloud-mybatisplus";
    /**
     * <p>
     * 读取控制台内容
     * </p>
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + PROJECT_NAME_PATH;
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("chaoscoffee");
        gc.setOpen(false);
